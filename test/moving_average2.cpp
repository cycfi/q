 ...
 , float sps, std::size_t n)
{
   ...
   q_test::write_golden_csv("results/golden/moving_average_" + name + ".csv", g_cols, g_rows);
   q_test::compare_golden_csv("moving_average_" + name, g_cols, g_rows);
}
...
TEST_CASE("moving_average2: audio files")
{
