 ...
 , float sps, q::frequency f)
{
   ...
   q_test::write_golden_csv("results/golden/zero_crossing_" + name + ".csv", g_cols, g_rows);
   q_test::compare_golden_csv("zero_crossing_" + name, g_cols, g_rows);
}
...
TEST_CASE("zero_crossing: audio files")
{
