...
https://www.boost.org/LICENSE_1_0.txt[Boost Software License, Version 1.0].
...
image:joel.jpg[alt="Joel de Guzman", width=150, role=right] Joel got into electronics and programming in the 80s because almost
