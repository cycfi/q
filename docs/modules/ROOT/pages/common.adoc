...
:NonLinearValue: xref:reference/units.adoc#_nonlinearvalue[NonLinearValue]
...
:moving_sum: xref:reference/moving_sum.adoc[Moving Sum]
:mono-moving_sum: xref:reference/moving_sum.adoc[moving_sum]

:phase: xref:reference/units/phase.adoc[phase]
:phase_iterator: xref:reference/units/phase_iterator.adoc[phase_iterator]

:oscillator: xref:reference/synth.adoc#_osc[Oscillator]
:basic_osc: xref:reference/synth.adoc#_basicsynth[BasicOscillator]
:bandlimited_osc: xref:reference/synth.adoc#_bandlimitedsynth[BandwidthLimitedOscillator]
