...
:integral-concept: https://en.cppreference.com/w/cpp/concepts/integral[std::integral<T>]
:floating-point-concept: https://en.cppreference.com/w/cpp/concepts/floating_point[std::floating_point<T>]
