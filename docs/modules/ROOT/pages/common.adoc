...
:moving_sum: xref:reference/misc_fx/moving_sum.adoc[Moving Sum]
:mono-moving_sum: xref:reference/misc_fx/moving_sum.adoc[moving_sum]
...
:noise_gate: xref:reference/misc_fx/noise_gate.adoc[noise_gate]
