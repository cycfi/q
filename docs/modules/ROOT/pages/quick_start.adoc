...
https://github.com/cycfi/Q/blob/master/example/delay/delay.cpp[example/delay/delay.cpp]. See also its xref:examples/delay.adoc[example page].
...
NOTE: The full example can be found here:
https://github.com/cycfi/Q/blob/master/example/square_synth/square_synth.cpp[example/square_synth/square_synth.cpp]. See also its xref:examples/square_synth.adoc[example page].
