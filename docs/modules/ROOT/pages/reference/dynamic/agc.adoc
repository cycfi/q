...
image:agc.svg[alt="AGC", width=300, role=right]The `agc`, or automatic gain control, compares the envelope, `env`, to an external reference, `ref`, and increases or decreases the gain to maintain a constant output level.
