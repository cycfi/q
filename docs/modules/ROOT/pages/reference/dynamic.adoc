...
As an example, here's the code for the compressor:
...
* Doing computations in the logarithmic is very natural and makes the code very easy to understand, compared to their linear counterparts.
