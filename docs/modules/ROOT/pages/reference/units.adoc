...
For brevity, we refer to `arithmetic_scalar` types as scalar types.
...
| `a += v`     | Add assign with a scalar.                      | `Value&`
| `a -= b`     | Subtract assign.                               | `Value&`
| `a -= v`     | Subtract assign with a scalar.                 | `Value&`
| `a *= v`     | Multiply assign with a scalar.                 | `Value&`
| `a /= v`     | Divide assign with a scalar.                   | `Value&`
| `a + b`      | Addition.                                      | `Value`
