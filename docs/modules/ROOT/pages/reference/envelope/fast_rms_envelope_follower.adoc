...
1. Square the signal.
2. Apply the Fast averaging envelope follower. The moving average filter in the Fast averaging envelope follower returns the arithmetic mean of the squared values.
